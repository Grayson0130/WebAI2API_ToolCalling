...
export const manifest = {
    ...
    // 模型列表
    models: [
        { type: 'text', id: 'deepseek', imagePolicy: 'forbidden' },
        { type: 'text', id: 'deepseek-thinking', imagePolicy: 'forbidden', thinking: true },
        { type: 'text', id: 'deepseek-search', imagePolicy: 'forbidden', search: true },
        { type: 'text', id: 'deepseek-thinking-search', imagePolicy: 'forbidden', thinking: true, search: true },
        { type: 'text', id: 'deepseek-expert', imagePolicy: 'forbidden' },
        { type: 'text', id: 'deepseek-thinking-expert', imagePolicy: 'forbidden', thinking: true },
        { type: 'text', id: 'deepseek-search-expert', imagePolicy: 'forbidden', search: true },
        { type: 'text', id: 'deepseek-thinking-search-expert', imagePolicy: 'forbidden', thinking: true, search: true },
    ],
